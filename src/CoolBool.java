...
public class Map4<K, V> extends MapSecondary<K, V> {
    ...
    private void createNewRep(int hashTableSize) {
        ...
        //Initializes an array of maps (hash table) of specified size
        this.hashTable = new Map[hashTableSize];

        //Initializes size as 0
        this.size = 0;

        //Populates every index with an empty map
    ...
    public final void add(K key, V value) {
        ...
        //Finds bucket to put pair into
        int i = mod(key.hashCode(), this.hashTable.length);

        //Puts pair into bucket and increases size by 1
    ...
    public final Pair<K, V> remove(K key) {
        ...
        //Finds bucket to remove pair from
        int i = mod(key.hashCode(), this.hashTable.length);

        //Reduces size by 1 and removes pair
        this.size -= 1;
    ...
    public final Pair<K, V> removeAny() {
        ...
        //Initializes variable to keep track of index
        int j = 0;

        //Iterates through the hash table until it finds a non-empty map at index j
        ...
        //reduces size by 1 and returns any pair from the non-empty map at index j
        this.size -= 1;
        return this.hashTable[j].removeAny();
    }
    ...
    public final V value(K key) {
        ...
        //Finds bucket that has specified key
        int i = mod(key.hashCode(), this.hashTable.length);
    ...
    public final boolean hasKey(K key) {
        ...
        //Finds bucket that would have specified key
        int i = mod(key.hashCode(), this.hashTable.length);

        //Returns whether the bucket has specified key
